  ...
  <ul>
    ...
    <li class="mb-4">
      <a href="{{ route('manager.dashboard') }}"
        class="flex items-center p-2 text-gray-700 transition duration-200 {{ isActive('manager.dashboard') }}">
        <!-- Dashboard Icon -->
    ...
    <!-- Item Categories -->
    <li class="mb-4">
      <a href="{{ route('manager.item-categories') }}"
        class="flex items-center p-2 text-gray-700 transition duration-200 {{ isActive('manager.item-categories') }}">
        <!-- Categories Icon -->
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-sweetOrange mr-3" fill="none" viewBox="0 0 24 24"
          stroke="currentColor" aria-hidden="true">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <!-- Items -->
    <li class="mb-4">
      <a href="{{ route('manager.item-products') }}"
        class="flex items-center p-2 text-gray-700 transition duration-200 hover:bg-sweetBlue {{ isActive('manager.item-products') }}">
        <!-- Products Icon -->
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-sweetOrange mr-3" fill="none" viewBox="0 0 24 24"
          stroke="currentColor" aria-hidden="true">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <li class="mb-4">
      <a href="{{ route('manager.orders.index') }}"
        class="flex items-center p-2 text-gray-700 transition duration-200 {{ isActive('manager.orders*') }}">
        <!-- Orders Icon -->
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-sweetOrange mr-3" fill="none" viewBox="0 0 24 24"
          stroke="currentColor" aria-hidden="true">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <!-- Transact Orders (POS) -->
    <li class="mb-4">
      <a href="{{ route('manager.pos') }}"
        class="flex items-center p-2 text-gray-700 transition duration-200 {{ isActive('manager.pos') }}">
        <!-- POS Icon -->
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-sweetOrange mr-3" fill="none" viewBox="0 0 24 24"
          stroke="currentColor" aria-hidden="true">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <li class="mb-4">
      <a href="{{ route('manager.users') }}"
        class="flex items-center p-2 text-gray-700 transition duration-200 {{ isActive('manager.users') }}">
        <!-- Users Icon -->
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-sweetOrange mr-3" fill="none" viewBox="0 0 24 24"
          stroke="currentColor" aria-hidden="true">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <!-- User Feedbacks -->
    <li class="mb-4">
      <a href="{{ route('manager.submit-feedback') }}"
        class="flex items-center p-2 text-gray-700 transition duration-200 {{ isActive('manager.submit-feedback') }}">
        <!-- Feedback Icon -->
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-sweetOrange mr-3" fill="none" viewBox="0 0 24 24"
          stroke="currentColor" aria-hidden="true">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <li class="mb-4">
      <a href="{{ route('manager.audit') }}"
        class="flex items-center p-2 text-gray-700 transition duration-200 {{ isActive('manager.audit*') }}">
        <!-- Audit Logs Icon -->
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-sweetOrange mr-3" fill="none" viewBox="0 0 24 24"
          stroke="currentColor" aria-hidden="true">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
