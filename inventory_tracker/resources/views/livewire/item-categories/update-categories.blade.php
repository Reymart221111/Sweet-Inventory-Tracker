<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" x-show="openEditModal"
    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md mx-4" x-show="openEditModal" @update-event.window="openEditModal = false"
        ...
        <div class="flex items-center justify-between border-b border-gray-300 p-4">
            <h2 class="text-xl font-semibold text-sweetPinkDark">Update Category</h2>
            <button @click="openEditModal = false" class="text-gray-600 hover:text-gray-800 focus:outline-none">
        ...
        <form wire:submit.prevent='updateCategory' class="p-4">
            <div class="mb-4">
